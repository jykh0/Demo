...
// Import Assets
// @ts-ignore
import tutorVideo from '../../assets/dummyfiles/tutorvideo.mp4';
// @ts-ignore
import ewaste0 from '../../assets/dummyfiles/slideshow images/ewaste0.jpg';
// @ts-ignore
import ewaste1 from '../../assets/dummyfiles/slideshow images/ewaste1.jpg';
// @ts-ignore
import ewaste2 from '../../assets/dummyfiles/slideshow images/ewaste2.jpg';
// @ts-ignore
import ewaste3 from '../../assets/dummyfiles/slideshow images/ewaste3.jpg';
// @ts-ignore
import ewaste4 from '../../assets/dummyfiles/slideshow images/ewaste4.jpg';
// @ts-ignore
import ewaste5 from '../../assets/dummyfiles/slideshow images/ewaste5.jpg';
// @ts-ignore
import ewaste6 from '../../assets/dummyfiles/slideshow images/ewaste6.jpg';
// @ts-ignore
import ewaste7 from '../../assets/dummyfiles/slideshow images/ewaste7.jpg';
// @ts-ignore
import ABC from '../../assets/dummyfiles/slideshow images/ABC.jpg';

const slideshowImages = [ABC, ewaste0, ewaste1, ewaste2, ewaste3, ewaste4, ewaste5, ewaste6, ewaste7];

const DummyWatchCourse: React.FC = () => {
    ...
    // Slideshow Logic - starts after loading completes
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900 overflow-x-hidden">
            ...
            {/* Module Indicator - Only for 1 second */}
            {showModuleIndicator && (
                ...
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-gray-200 pb-6">
                    <div className="space-y-2">
                        <div className="flex items-center gap-2 text-sm font-medium text-gray-500 mb-2">
                            ...
                            <span className="text-gray-900">Course Viewer</span>
                        </div>
                        <h1 className="text-3xl lg:text-4xl font-extrabold text-gray-900 tracking-tight">
                            Module 1: E-Waste Management
                        </h1>
                ...
                <div className="max-w-6xl mx-auto space-y-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className="p-4 space-y-3">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <h4 className="font-bold text-gray-900 text-base leading-tight mb-1">E-Waste Basics - Introduction to Electronic Waste</h4>
                                        ...
                                        <span className="text-sm font-semibold text-blue-600">12:30</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Inactive Modules */}
                            {[2, 3].map((num) => (
                                <div key={num} className="group flex gap-4 p-4 rounded-xl hover:bg-gray-50 border border-transparent hover:border-gray-100 cursor-pointer transition-all">
                                    <div className="flex-shrink-0 pt-1">
                                        <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 text-sm font-bold group-hover:bg-white group-hover:shadow-sm transition-all border border-gray-200">
                                            {num}
                                        </div>
                                    </div>
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <h4 className="font-bold text-gray-700 text-base leading-tight mb-1 group-hover:text-blue-600 transition-colors">
                                                    {num === 2 ? 'Recycling Methods and Best Practices' : 'Global Impact and Future Solutions'}
                                                </h4>
                                                <p className="text-sm text-gray-400 max-w-2xl">
                                                    {num === 2 ? 'Discover standard procedures for safe recycling.' : 'Understand what the future holds for e-waste management.'}
                                                </p>
                                            </div>
                                            <span className="text-sm font-medium text-gray-400">15:00</span>
                                        </div>
                                    </div>
...
export default DummyWatchCourse;
